...
var update = function update(username, password, password_confirmation) {
  return function (dispatch) {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      var url = "/api/users/".concat(username);
      var userData = {
      ...
      resolve(_services_axios_axios_user__WEBPACK_IMPORTED_MODULE_2__["default"].patch(url, userData).then(function (response) {
...
//# sourceMappingURL=update.js.c5e5dab8513b4239e129.hot-update.js.map