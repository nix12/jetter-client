...
function (_Component) {
  ...
  function Update() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "submitHandler", function (event) {
      ...
      _this.props.onUpdate(localStorage.getItem('userId'), _this.state.controls.password.value, _this.state.controls.password_confirmation.value).then(function () {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onUpdate: function onUpdate(userId, password, password_confirmation) {
      return dispatch(_store_actions_index__WEBPACK_IMPORTED_MODULE_15__["update"](userId, password, password_confirmation));
    }
  };
};
...
//# sourceMappingURL=update.js.3e2f7b206a92d145486a.hot-update.js.map