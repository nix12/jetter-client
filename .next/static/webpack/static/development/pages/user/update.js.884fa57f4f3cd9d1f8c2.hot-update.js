...
var update = function update(username, password, password_confirmation) {
  return function (dispatch) {
    return new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (resolve, reject) {
      ...
      resolve(_services_axios_axios_user__WEBPACK_IMPORTED_MODULE_2__["default"].patch(url, userData));
    });
  };
};
...
//# sourceMappingURL=update.js.884fa57f4f3cd9d1f8c2.hot-update.js.map