webpackHotUpdate("static/development/pages/auth/logout.js",{
...
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth */ "./store/actions/auth.js");
...
/* harmony import */ var _services_casl_ability__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/casl/ability */ "./services/casl/ability.js");
...
var authFail = function authFail(error) {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_3__["AUTH_FAIL"],
    error: error
  };
};
...
var logout = function logout() {
  return function (dispatch) {
    ...
    _auth__WEBPACK_IMPORTED_MODULE_2__["removeCookie"]();
    _services_casl_ability__WEBPACK_IMPORTED_MODULE_4__["default"].update([]);
    dispatch(authLogout());
  };
};
var auth = function auth(username, password) {
  return function (dispatch) {
    ...
    _services_axios_axios_user__WEBPACK_IMPORTED_MODULE_0__["default"].post(url, authData).then(function (response) {
      ...
      _services_casl_ability__WEBPACK_IMPORTED_MODULE_4__["default"].update(response.data.user.rules);
  ...
  return function (dispatch) {
    ...
    if (!token) {
      ...
      if (expirationDate <= new Date().getTime()) {
        ...
        _services_casl_ability__WEBPACK_IMPORTED_MODULE_4__["default"].update(cookies.get('rules'));
...
//# sourceMappingURL=logout.js.f623ddf6c756b7a0ebbc.hot-update.js.map